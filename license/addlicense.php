...
<head>
    ...
    <link rel="stylesheet" href="../assets/css/license/addlicense.css">
...
<body onload='enableDarkMode()'>
    ...
    <div class="snContent">
        ...
        <div class="Glowne">
        <div class="Glowne__box">
          <div class="dbRow" id="dbAdd">
            <div class="dbRow__box">
              <div class="dbWidget">
                <h3 class="dbWidget__title">
                  <i class="fa-duotone fa-square-plus"></i> Dodawanie klucza
                </h3>
                <form class="dbWidget__content" method="POST" action="https://dottbuff.eu/license/addsave">
                  <ul class="dbAuth__form">
                    <li class="dbAuth__form--row">
                      <div class="dbAuth__form--row__content">
                        <input type="text" class="form-control form-control-user" name="key" id="key"
                          placeholder="Wprowadź klucz" value="">
                      </div>
                    </li>
                    <li class="dbAuth__form--row">
                      <div class="dbAuth__form--row__content">
                        <input type="text" class="form-control form-control-user" name="ip" id="ip"
                          placeholder="Wprowadź IP serwera" value="">
                      </div>
                    </li>
                    <li class="dbAuth__form--row">
                      <div class="dbAuth__form--row__content">
                        <input type="text" class="form-control form-control-user" name="script" id="script"
                          placeholder="Wprowadź nazwę skryptu" value="">
                      </div>
                    </li>
                    <li class="dbAuth__form--row">
                      <div class="dbAuth__form--row__content">
                        <input type="text" class="form-control form-control-user" name="buyer" id="buyer"
                          placeholder="Wprowadź nick kupującego" value="">
                      </div>
                    </li>
                    <li class="dbAuth__form--row">
                      <div class="dbAuth__form--row__content">
                        <select class="form-control form-control-user" name="time" id="time">
                          <option value="86400">1 dzień</option>
                          <option value="604800">7 dni</option>
                          <option value="1209600">14 dni</option>
                          <option value="2678400">31 dni</option>
                          <option value="10431630840">Lifetime</option>
                        </select>
                      </div>
                    </li>
                    <li class="dbAuth__form--row">
                      <div class="dbAuth__form--row__content">
                        <button type="submit" name="submit">
                          <i class="fa-duotone fa-square-plus"></i> Dodaj
                        </button>
                      </div>
                    </li>
                  </ul>
