...
<head>
    ...
    <link rel="stylesheet" href="../assets/css/license/license.css">
...
<body onload='enableDarkMode()'>
    ...
    <div class="snContent">
        <div class="snContent__title">
            ...
            <div class="snContent__button">
                <a href="addlicense.php">
                    <i class="fa-sold fa-plus"></i> Dodaj
                </a>
            </div>
        </div>
        <div class="dbMain">
            <div class="dbMain__box">
                <div class="dbRow" id="dbLicense__list">
