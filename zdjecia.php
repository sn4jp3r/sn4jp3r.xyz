...
<body onload='enableDarkMode()'>
    ...
    <div class="snContent">
        ...
        <div class="snContent__input">
            <button class="btn"><i class='bx bxs-file-import icon'></i>Wybierz Plik</button>
            
            <button class="btn"><i class='bx bxs-save icon'></i>Zapisz</button>
        </div>
